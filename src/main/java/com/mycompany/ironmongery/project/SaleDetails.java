...
public class SaleDetails extends javax.swing.JFrame {
    ...
    public SaleDetails(int ventaId) {
        initComponents();
    ...
    private void cargarProducto() {
        ...
        try {
            ...
            if(rs.next()) {
                ...
                txtProductoId.setText("Venta Nº " + rs.getInt("VentaId"));
                txtNombre.setText(rs.getString("Cliente"));
                txtPrecio.setText(rs.getString("Total"));
                txtStock.setText(rs.getString("FechaVenta"));

                Object[] fila = new Object[4];
                fila[0] = rs.getString("Nombre");
                fila[1] = rs.getBigDecimal("PrecioUnitario");
                fila[2] = rs.getInt("Cantidad");
                fila[3] = rs.getBigDecimal("SubTotal");
    ...
    private void initComponents() {
        ...
        txtProductoId.setText("Venta Nº 1");
